...
//-------------------------- SSH
// xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx SSH PUTTY KE  ubuntu@108.136.183.85
//-------------------------- SSH


// HARRUS 1 , 1 LANE CONFIG SERVERNYA
...
// docker container exec -it db-client-1st /bin/sh
...
rs.initiate(
  {
      _id: "db-client-repset",
      members: [
          {
              _id: 0,
              host: "52.74.145.122:7000",
              priority: 0
          },
          {
              _id: 1,
              host: "52.74.145.122:7001",
              priority: 1
          }
      ]
  }
